...
import re
from models.convector.convector_value_tab import convector_value_tab
from models.convector.convector_split_model import convector_split_model
...
class HeaterTestApp(QMainWindow):
    ...
    def set_tabs_for_model(self, model):
        ...
        if model.startswith("HP"):
            ...
            convector_value_tab(self, model, convector_split_model)
